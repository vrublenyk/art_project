...
var accordion = function accordion(triggersSelector) {
  var trigger = document.querySelectorAll(triggersSelector); //   content = document.querySelectorAll(itemsSelector);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(burgerSelector, menu) {
  var menuElem = document.querySelector(menu),
      burgerElem = document.querySelector(burgerSelector);
  menuElem.style.display = 'none'; // burgerElem.addEventListener('click', () => {
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    wrapper.querySelectorAll('.all').forEach(function (item) {
  ...
  function tab(selector) {
    var btnSelector = menu.querySelector(selector);
    var markSelector = wrapper.querySelectorAll(selector);
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.getAttribute('data-clac') === 'end') {
...
var mask = function mask(selector) {
  var setCoursorPosition = function setCoursorPosition(pos, elem) {
    elem.focus();
...
var scrolling = function scrolling(upSelector) {
  ...
  //                 hashElementTop += hashElement.offetTop;
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  wrapper = document.querySelector('#styles'); // cards.forEach(card => {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", status ").concat(res.sattus));
